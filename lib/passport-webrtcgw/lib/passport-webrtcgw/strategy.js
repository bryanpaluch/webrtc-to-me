...
function Strategy(options, verify) {
  options = options || {};
  options.requestTokenURL = options.requestTokenURL || 'http://10.255.132.197:3002/oauth/request_token';
  options.accessTokenURL = options.accessTokenURL || 'http://10.255.132.197:3002/oauth/access_token';
  options.userAuthorizationURL = options.userAuthorizationURL || 'http://10.255.132.197:3002/dialog/authorize';
  options.sessionKey = options.sessionKey || 'authorize';
