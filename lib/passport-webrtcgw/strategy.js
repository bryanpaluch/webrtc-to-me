 ...
 *
 * The WebRTC GW authentication strategy authenticates requests by delegating to
 * webrtcgw using the OAuth protocol.
 *
...
function Strategy(options, verify) {
  options = options || {};
  options.requestTokenURL = options.requestTokenURL || 'https://10.255.132.197:3002/oauth/request_token';
  options.accessTokenURL = options.accessTokenURL || 'https://10.255.132.197:3002/oauth/access_token';
  options.userAuthorizationURL = options.userAuthorizationURL || 'https://10.255.132.197:3002/dialog/authorize';
  options.sessionKey = options.sessionKey || 'oauth:webrtcgw';
  
  OAuthStrategy.call(this, options, verify);
  this.name = 'webrtcgw';
  
  //this._skipExtendedUserProfile = (options.skipExtendedUserProfile === undefined) ? false : options.skipExtendedUserProfile;
  this._skipExtendedUserProfile = true;
}
